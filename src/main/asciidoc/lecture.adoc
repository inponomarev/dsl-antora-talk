...
* The choice of DSL approach is context-dependent, possible options are: a fully custom DSL, an existing spec language (e.g., OpenAPI or XSD), a YAML/XML-based format, or an internal DSL in a host language such as Ruby or Kotlin.
...
<.> Euclid’s step: reduce the problem size and recurse
--
...
[source,ruby]
----
include::../resources/gcd.rb[tag=snippet]
----
-----

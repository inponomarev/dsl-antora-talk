...
|===
|
* **JSON Schema for the YAML configuration**
...
digraph UpsideDownTree {
  ...
  yaml   [label="JSON Schema for YAML config"];
  proj   [label="JSON Schema for Projectional Editor"];
...
edge  [color="#666666", arrowsize=0.7];
  ...
  jsongen -> jsonschema[label="JSON Schema"];
